  ...
  <div class="app-container" style="position: relative; height: calc(100vh - 117px);">
    <div class="container">
      ...
      <el-table ref="multipleTable" v-loading="loading" :data="data" size="small" style="width: 100%;" @selection-change="handleSelectionChange">
        ...
        <el-table-column v-if="checkPermission(['admin','SHOPSTOREORDER_ALL','SHOPSTOREORDER_EDIT','SHOPSTOREORDER_DELETE'])" label="操作" width="200" align="center" fixed="right">
          <template slot-scope="scope">
            <el-button
              v-permission="['admin','SHOPSTOREORDER_ALL','SHOPSTOREORDER_EDIT']"
              size="mini"
              type="primary"
            ...
            <el-dropdown size="mini" split-button type="primary" trigger="click">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item v-if="scope.row._status == 1">
                  <el-popover
                    :ref="scope.row.id"
                    v-permission="['admin','SHOPSTOREORDER_ALL','SHOPSTOREORDER_DELETE']"
                    placement="top"
                    width="180"
                  >
                    <p>确定删除本条数据吗？</p>
...
<script>
  ...
  import { del } from '@/api/shopStoreOrder'
