<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['admin','SHOPSTOREPRODUCT_ALL','SHOPSTOREPRODUCT_EDIT','SHOPSTOREPRODUCT_DELETE'])" label="操作" width="150px" align="center">
        <template slot-scope="scope">
          <el-button v-permission="['admin','SHOPSTOREPRODUCT_ALL','SHOPSTOREPRODUCT_EDIT']" size="mini" type="primary" icon="el-icon-edit" @click="edit(scope.row)" />
          <el-popover
            :ref="scope.row.id"
            v-permission="['admin','SHOPSTOREPRODUCT_ALL','SHOPSTOREPRODUCT_DELETE']"
            placement="top"
            width="180"
          >
            <p>确定恢复本条数据吗？</p>
...
import { recovery, onsale } from '@/api/shopStoreProduct'
