<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column prop="storeCategory.cateName" label="分类" />
      <el-table-column prop="shopBrandDto.brandName" label="品牌" />
  ...
  methods: {
    ...
    edit(data) {
      ...
      _this.form = {
        ...
        shopBrandDto: data.shopBrandDto || {id:null},
        price: data.price,
    ...
    attr(data) {
      ...
      _this.form = {
        ...
        shopBrandDto: data.shopBrandDto,
        price: data.price,
        vipPrice: data.vipPrice,
        otPrice: data.otPrice,
        postage: data.postage,
