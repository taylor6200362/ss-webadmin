...
<script>
import crudShopUserRecharge from '@/api/shopUserRecharge'
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '充值管理', url: 'api/shopUserRecharge', sort: 'id,desc', crudMethod: { ...crudShopUserRecharge }, optShow: { add: false, edit: false, del: true, download: true}})
...
export default {
  name: 'ShopUserRecharge',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(defaultCrud), header(), form(defaultForm), crud()],
  data() {
    return {
      permission: {
        add: ['admin', 'shopUserRecharge:add'],
        edit: ['admin', 'shopUserRecharge:edit'],
        del: ['admin', 'shopUserRecharge:del']
      },
      rules: {
      },
      queryTypeOptions: [
