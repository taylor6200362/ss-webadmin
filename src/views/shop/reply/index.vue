<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['admin','SHOPSTOREPRODUCTREPLY_ALL','SHOPSTOREPRODUCTREPLY_EDIT','SHOPSTOREPRODUCTREPLY_DELETE'])" label="操作" width="150px" align="center">
        <template slot-scope="scope">
          <el-popover
            :ref="scope.row.id"
            v-permission="['admin','SHOPSTOREPRODUCTREPLY_ALL','SHOPSTOREPRODUCTREPLY_DELETE']"
            placement="top"
            width="180"
          >
            <p>确定删除本条数据吗？</p>
...
import { del } from '@/api/shopStoreProductReply'
...
export default {
  ...
  methods: {
    ...
    checkPermission,
    beforeInit() {
      this.url = 'api/shopStoreProductReply'
      const sort = 'id,desc'
