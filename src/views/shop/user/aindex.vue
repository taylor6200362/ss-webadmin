<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <!---->
      <!--<el-table-column v-if="checkPermission(['admin','SHOPUSER_ALL','SHOPUSER_EDIT','SHOPUSER_DELETE'])" label="操作" width="150px" align="center">-->
      <!--<template slot-scope="scope">-->
      <!--<el-button v-permission="['admin','SHOPUSER_ALL','SHOPUSEREDIT']" size="mini" type="primary" icon="el-icon-edit" @click="edit(scope.row)"/>-->
      <!--<el-popover-->
      <!--v-permission="['admin','SHOPUSER_ALL','SHOPUSERDELETE']"-->
      <!--:ref="scope.row.uid"-->
      <!--placement="top"-->
      <!--width="180">-->
      <!--<p>确定删除本条数据吗？</p>-->
...
import { del, onStatus } from '@/api/shopUser'
