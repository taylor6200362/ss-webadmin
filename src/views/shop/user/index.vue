<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['admin','SHOPUSER_ALL','SHOPUSER_EDIT','SHOPUSER_DELETE'])" label="操作" width="185" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button
            v-permission="['admin','SHOPUSER_ALL','SHOPUSEREDIT']"
            size="mini"
            type="primary"
            icon="el-icon-edit"
          ...
          <el-dropdown size="mini" split-button type="primary" trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>
                <el-button
                  v-permission="['admin','SHOPUSERALL','SHOPUSEREDIT']"
                  size="mini"
                  type="primary"
          ...
          <!--
         <el-popover
            v-permission="['admin','SHOPUSERALL','SHOPUSERDELETE']"
            :ref="scope.row.uid"
            placement="top"
            width="180">
            <p>确定删除本条数据吗？</p>
